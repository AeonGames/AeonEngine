...
def main(context):
    ...
    for key, value in armature.edit_bones.items():
        if len(value.children) == 1 and not value.children[0].use_connect and (value.head - value.children[0].head).length >= 0.0001:
            before = value.matrix
            ...
            for action in bpy.data.actions:
                print(len(action.groups[value.name].channels[0].keyframe_points))
                print(len(action.groups[value.name].channels[1].keyframe_points))
                print(len(action.groups[value.name].channels[2].keyframe_points))
                print(len(action.groups[value.name].channels[3].keyframe_points))
                print(len(action.groups[value.name].channels[4].keyframe_points))
                print(len(action.groups[value.name].channels[5].keyframe_points))
                print(len(action.groups[value.name].channels[6].keyframe_points))
                print(len(action.groups[value.name].channels[7].keyframe_points))
                print(len(action.groups[value.name].channels[8].keyframe_points))
                print(len(action.groups[value.name].channels[9].keyframe_points))
