...
namespace AeonGames
{
    ...
    FreeCamera::FreeCamera() : Component{}
    {
        ...
        mActionMap.Bind ( Action_MoveUp,       KeyCode::E );
        mActionMap.Bind ( Action_MoveDown,     KeyCode::Q );
        mActionMap.Bind ( Action_LookLeft,     KeyCode::Left );
        mActionMap.Bind ( Action_LookRight,    KeyCode::Right );
        mActionMap.Bind ( Action_LookUp,       KeyCode::Up );
        mActionMap.Bind ( Action_LookDown,     KeyCode::Down );
        mActionMap.Bind ( Action_Boost,        KeyCode::LeftShift );
    }
