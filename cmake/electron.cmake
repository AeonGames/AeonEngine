...
elseif(WIN32 AND MINGW)
	...
	if(NOT EXISTS "${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/libnode.a")
		...
		execute_process(
            COMMAND ${DLLTOOL} --dllname node.exe --def electron.def --output-delaylib ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/libnode.a WORKING_DIRECTORY ${CMAKE_BINARY_DIR})
    endif()
    set(NODE_LIBRARY ${CMAKE_LIBRARY_OUTPUT_DIRECTORY}/libnode.a CACHE PATH "Node library location")
endif()
