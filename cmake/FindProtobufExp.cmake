...
# Copyright 2016 Rodrigo Hernandez, AeonGames
#
...
if(PROTOBUF_FOUND)
  function(PROTOBUF_GENERATE_EXPORT_CPP SRCS HDRS MACRO_NAME)
    if(NOT ARGN)
      message(
        SEND_ERROR
          "Error: PROTOBUF_GENERATE_EXPORT_CPP() called without any proto files"
        )
      return()
    endif()
    ...
    foreach(FIL ${ARGN})
      ...
      if(WIN32 AND MACRO_NAME)
        set(cpp_out
            --cpp_out=dllexport_decl=${MACRO_NAME}:${CMAKE_CURRENT_BINARY_DIR})
      else()
